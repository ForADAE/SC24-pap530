    ...
    def __gloo_all_to_all(self,
        ...
        for i in range(1, size):
            ...
            if forward:
                ...
                send_cpu[right].copy_(
                    send_gpu[self._pl[right]:self._pr[right]])
        ...
        while not req.empty():
            ...
            if forward:
                ...
                send_gpu[self._selected[idx]] += recv_cpu[idx].cuda(
                    non_blocking=True) / self._ratio[idx]
